...
- [ ] **AGH-004 Add agent trust states and probation.** Support trust/reputation
  states for agents.
...
- [ ] **AGH-005 Add agent background-check checklist.** Define a local checklist
...
- [ ] **AGH-006 Add structured approval request schema.** Replace vague approval
...
- [ ] **AGH-016 Add tamper-evident local audit chain.** Add lightweight
