...
import type { AgentAction, AgentChannelStatus, AgentMessage, BackendConnection, ConfigStatus, Contact, DataStatus, DesktopStatus, McpStatus, Message, SignalItem, SignalSubscription, Thread, View } from "./types";
