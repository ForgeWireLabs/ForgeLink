...
function ingressEvent(overrides: Record<string, unknown> = {}) {
  return {
    ...
    failure_category: "", connection_id: "", from_number: "", to_number: "", partial_content: null, transient_media_url: "", transient_media_expires_at: "", delivery_target_hash: "", payload_sha256: "hash-race",
