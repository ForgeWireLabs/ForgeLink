...
> (`3.0.2`, pinned in [`requirements-repopact.txt`](../requirements-repopact.txt))
...
Pinned RepoPact version: [`REPOPACT_VERSION`](REPOPACT_VERSION) / `requirements-repopact.txt` (currently 3.0.2).
